 ...
 * Use of this code is entirely at your own risk.
  * Modified for Neomatrix By Pierre Goude
 */
...
#define LEDCOUNT   40       // Number of LEDs used for boblight
#define SHOWDELAY  10       // Delay in micro seconds before showing
#define BAUDRATE   460800    // Serial port speed, 460800 tested with Arduino Uno R3
#define BRIGHTNESS 100
 // Max. brightness in %

const char prefix[] = {0x41, 0x64, 0x61, 0x00, 0x1A, 0x4F};  // Start prefix
...
Adafruit_NeoPixel pixels = Adafruit_NeoPixel(LEDCOUNT, DATAPIN, NEO_GRB + NEO_KHZ800);
